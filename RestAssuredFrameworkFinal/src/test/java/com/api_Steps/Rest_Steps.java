...
public class Rest_Steps {
	...
	public void i_want_the_new_user_to_be_created_through_HTTP_Method_using_the_endpoint(String arg1, String arg2,
	...
	@Then("^I send a \"([^\"]*)\" call for \"([^\"]*)\" to get the information for that user$")
	public void i_send_a_call_for_to_get_the_information_for_that_user(String arg1, String arg2) throws Throwable {
		Response l = callAPI.executeRquest(arg1, arg2);
		l.prettyPrint();
		System.out.println("Statue code " + l.statusCode() + " means we got the correct information");
	}

	@Then("^I want the  new user to be delted  through \"([^\"]*)\" HTTP Method using the endpoint \"([^\"]*)\"$")
	public void i_want_the_new_user_to_be_delted_through_HTTP_Method_using_the_endpoint(String arg1, String arg2)
			throws Throwable {

		ResponseBody o = callAPI.executeRquest(arg1, arg2);
